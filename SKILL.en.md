...
**English version of the skill definition for Enterprise WeChat (WeCom) MCP integration.**
...
One-stop Enterprise WeChat automation solution that unifies Document, Calendar, Meeting, Todo, and Contact operations through the official WeCom MCP APIs. Fully integrated with OpenClaw's MCP layer.
